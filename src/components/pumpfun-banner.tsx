...
export function PumpFunBanner() {
  ...
  return (
    <div className="relative w-full overflow-hidden border-b border-[#00E676]/25 z-50">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#0A0A0F] via-[#00E676]/20 to-[#0A0A0F] animate-[shimmer_3s_ease-in-out_infinite]" />
      ...
      <div className="relative flex items-center justify-center gap-3 py-2 px-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 group cursor-pointer px-2 py-0.5 rounded border border-[#00E676]/10 hover:border-[#00D4FF]/40 bg-white/[0.02] hover:bg-[#00D4FF]/5 transition-all duration-300"
          title="Click to copy CA"
        >
          <span className="text-[10px] font-mono text-white/50 group-hover:text-[#00D4FF] transition-colors duration-300">
            CA: {CA.slice(0, 6)}...{CA.slice(-4)}
          </span>
          <span className="text-[10px] text-[#00E676]/40 group-hover:text-[#00D4FF] transition-colors duration-300">
            {copied ? "✓ copied" : "⧉"}
          </span>
        </button>
      </div>
